...
def show_menu():
    ...
    print('6) Klasyfikacja kanadyjska (gole + asysty)')
    print('7) Zapisz wynik ostatniego zapytania do CSV')
    print('0) Wyjście')
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            last_df = show_canadian_classification(data)
        elif choice == '7':
            if last_df is None:
